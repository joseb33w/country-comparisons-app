...
CountryScope is a polished browser app for comparing countries around the world and seeing a small personal bio comparison alongside the country data.
...
Country data is loaded client-side from the public REST Countries API.